  ...
  return (
    <div className="p-4">
      ...
      <table className="table-auto w-full border-collapse border border-gray-300">
        ...
        <td  className='p-2 border px-4 py-2'><button className=' bg-green-400 p-1
         rounded-sm cursor-pointer hover:bg-blue-600 hover:text-white border-2 border-black'>ADD ITEM +</button></td>  <td  className=' border px-4 py-2'><button className=' bg-red-400 
